...
# Asignar rango a cada palabra
word_freq_with_ranks = [(word, freq, rank + 1) for rank, (word, freq) in enumerate(word_freq)]

# Convertir a DataFrame de pandas
df = pd.DataFrame(word_freq_with_ranks, columns=['Palabra', 'Frecuencia', 'Rango'])

# Guardar el DataFrame en un archivo Excel
excel_file_path = r'D:\SEPTIMO SEMESTRE II\RI\KevinMaldonado99\RETRIEVAL INFO\week06\corpus\frecuencia_palabras_con_rango.xlsx'
